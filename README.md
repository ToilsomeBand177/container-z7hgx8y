...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-z7hgx8y.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-z7hgx8y.containers.anotherwebservice.com/
...
```
git clone git@github.com:ToilsomeBand177/container-z7hgx8y.git
cd container-z7hgx8y
```
...
```
docker attach container-z7hgx8y
```
